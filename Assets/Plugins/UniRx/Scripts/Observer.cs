...
namespace UniRx
{
    ...
    internal static class Stubs<T>
    {
        ...
        public static readonly Action<Exception, T> Throw = (ex, _) => { ex.Rethrow(); throw ex; };
    }

    internal static class Stubs<T1, T2>
    {
        public static readonly Action<T1, T2> Ignore = (x, y) => { };
        public static readonly Action<Exception, T1, T2> Throw = (ex, _, __) => { ex.Rethrow(); throw ex; };
    }
    ...
    internal static class Stubs<T1, T2, T3>
    {
        ...
        public static readonly Action<Exception, T1, T2, T3> Throw = (ex, _, __, ___) => { ex.Rethrow(); throw ex; };
    }
}