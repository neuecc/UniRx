...
namespace UniRx.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        {
            if (gameObject == null) Observable.Empty<int>();
        ...
        {
            if (gameObject == null) Observable.Empty<Unit>();
        ...
        {
            if (gameObject == null) Observable.Empty<Collision2D>();
        ...
        {
            if (gameObject == null) Observable.Empty<Collision>();
        ...
        {
            if (gameObject == null) Observable.Empty<Collider2D>();
        ...
        {
            if (gameObject == null) Observable.Empty<Collider>();
