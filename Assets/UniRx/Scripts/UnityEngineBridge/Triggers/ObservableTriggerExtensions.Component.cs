...
namespace UniRx.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        {
            if (component == null || component.gameObject == null) Observable.Empty<int>();
        ...
        {
            if (component == null || component.gameObject == null) Observable.Empty<Unit>();
        ...
        {
            if (component == null || component.gameObject == null) Observable.Empty<Collision2D>();
        ...
        {
            if (component == null || component.gameObject == null) Observable.Empty<Collision>();
        ...
        {
            if (component == null || component.gameObject == null) Observable.Empty<Collider2D>();
        ...
        {
            if (component == null || component.gameObject == null) Observable.Empty<Collider>();
